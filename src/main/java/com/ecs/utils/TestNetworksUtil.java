...
*/
//    @Async
    public static NetworkConditions getNetworkCondition() throws IOException {
    ...
    public static String getNetworkDelay() throws IOException {
        ...
        try {
            Process p = Runtime.getRuntime().exec("ping " + Networks.IP_ADRESS + " -n 1");
    ...
    public static String getNetworkPacketLoss() throws IOException {
        InetAddress address = InetAddress.getByName(Networks.IP_ADRESS);
        int packet_loss = 10;
        for(int i = 0;i < 10; i++)
